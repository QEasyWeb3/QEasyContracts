...
async function getGenesisTimestamp() {
    let block = await hre.ethers.provider.send("eth_getBlockByNumber", ['0x0', false])
    return block.timestamp;
}
...
module.exports = {getLatestTimestamp, getLatestCoinbase, ethToGwei, ethToWei, weiToGWei, weiToEth, gweiToWei, mineEmptyBlock, getGenesisTimestamp}